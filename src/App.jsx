  ...
  return (
    <>
      ...
      <div className="shadow shadow-xl rounded-lg flex bg-[#FCF7F3] justify-around flex-wrap max-sm:flex-col max-sm:justify-evenly max-sm:w-[100%] w-full">
        <div className=" flex justify-center items-center max-sm:h-auto w-auto">
     ...
     <div className="mt-15">
     <h1 className="text-[100px] max-lg:text-[70px] font-bold max-sm:text-[50px] text-center">Produits Disponible</h1>
      <div className="pt-10 grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 flex-wrap justify-items-center">
        <Produit src={smartphone} alt="redmi" prix="à partir 130.000 Ar" smartphone="Redmi"/>
        <Produit src={smartphone} alt="realme" prix="à partir 150.000 Ar" smartphone="Realmi"/>
        <Produit src={smartphone} alt="OPPO"prix="à partir 110.000 Ar" smartphone="OPPO"/>
        <Produit src={smartphone} alt="VIVO"prix="à partir 100.000 Ar" smartphone="VIVO"/>
        <Produit src={smartphone} alt="tablete"prix="à partir 300.000 Ar" smartphone="Tablette"/>
        <Produit src={smartphone} alt="huawai"prix="à partir 230.000 Ar" smartphone="Huawai"/>
      </div>
     </div>
    </>
  );
